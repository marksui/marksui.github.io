(function() {
  ...
  function createCommandPalette() {
    ...
    var commands = [
      ...
      { label: "MAGE RTL Report", href: "files/project-reports/mage-rtl-generation-routing-memory.pdf", meta: "Agentic routing and memory persistence for Verilog generation", group: "Projects", keywords: "rtl verilog mage vlsi coursework report" },
      { label: "GPU GGM Tree Report", href: "files/project-reports/ece268-ggm-tree-cuda-report.pdf", meta: "CUDA GGM tree construction with Keccak and Spongent", group: "Projects", keywords: "cuda cryptography ggm keccak spongent coursework report" },
