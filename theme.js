(function() {
  ...
  function optimizeImages(root) {
    ...
    Array.prototype.slice.call(scope.querySelectorAll("img")).forEach(function(image) {
      ...
      if (!image.hasAttribute("loading") && !image.closest(".photo-viewer")) {
  ...
  function scheduleScrolledState() {
    if (scrollTicking) {
      return;
    }
  ...
  function createCommandPalette() {
    ...
    var commands = [
      ...
      { label: "Resume", href: "resume.html", meta: "PDF preview, skill matrix, and download", group: "Resume", keywords: "cv download" },
      { label: "Contact", href: "contact.html", meta: "Email, profiles, and ready-to-contact paths", group: "Pages", keywords: "email linkedin contact" },
      ...
      { label: "Dual-Core ML Accelerator", href: "dual-core.html", meta: "INT8 attention hardware, CDC, and implementation tradeoffs", group: "Projects", keywords: "dual core rtl verilog sram ppa" },
      { label: "SystemVerilog Viterbi Decoder", href: "viterbi.html", meta: "Architecture, error injection, and recorded results", group: "Projects", keywords: "viterbi bmc acs traceback fpga" },
      ...
      { label: "CloserXR Sales Negotiator", href: "https://github.com/marksui/CSE165-CloserXR-Sales-Negotiator", meta: "Unity MR sales role-play with Gemini, speech, TTS, and avatar gestures", group: "Projects", keywords: "cse165 closerxr xr mixed reality unity csharp gemini quest speech avatar" },
      { label: "CloserXR Demo Video", href: "https://www.youtube.com/watch?v=en_fDR_AWmM", meta: "CSE 165 mixed-reality sales negotiator demo", group: "Projects", keywords: "closerxr demo video youtube cse165 xr sales negotiator" },
      { label: "MAGE RTL Generation", href: "files/project-reports/mage-rtl-generation-routing-memory.pdf", meta: "Agentic routing and memory persistence for Verilog generation", group: "Projects", keywords: "rtl verilog mage vlsi coursework report" },
      { label: "GPU-Accelerated GGM Tree Construction", href: "files/project-reports/ece268-ggm-tree-cuda-report.pdf", meta: "CUDA GGM tree construction with Keccak and Spongent", group: "Projects", keywords: "cuda cryptography ggm keccak spongent coursework report" },
      { label: "Climate Emulation Report", href: "https://github.com/marksui/Kaggle-Climate-Emulation-Model-Competition/blob/main/FINAL_REPORT.pdf", meta: "Kaggle climate emulation modeling workflow", group: "Projects", keywords: "kaggle climate emulation machine learning report data" },
  ...
  window.siteOptimizeImages = optimizeImages;
})();
